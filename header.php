        ...
        <div class="row gx-0 align-items-center" style="height: 45px;">
            <div class="col-lg-6 text-center text-lg-start mb-lg-0">
                <div class="d-flex flex-wrap">
                    <a href="#" class="text-white me-4"><i class="fa fa-map-marker text-muted me-2"></i>Dubai,
                        UAE</a>
                    <a href="tel:+971524312436" class="text-white me-4"><i class="fa fa-phone text-muted me-2"></i>+971
                        5243 12436</a>
                    <a href="mailto:info@travellinkuae.com" class="text-white me-0"><i
                            class="fa fa-envelope text-muted me-2"></i>info@travellinkuae.com</a>
                </div>
            </div>
            <div class="col-lg-6 text-center text-lg-end">
                <div class="d-flex align-items-center justify-content-end">
                    <a href="https://www.facebook.com/profile.php?id=61564022272903&mibextid=LQQJ4d"
                        class="btn btn-light btn-sm-square rounded-circle me-3" target="_blank"><i
